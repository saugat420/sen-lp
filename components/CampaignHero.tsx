...
export function CampaignHero({ registrationLink }: { registrationLink: string }) {
  return (
    <main className="page-shell flex items-start justify-center px-4 py-7 sm:px-8 lg:px-12 lg:py-10">
      ...
      <section className="relative mx-auto max-w-2xl text-center">
        ...
        <a href={registrationLink} target="_blank" rel="noreferrer" className="font-poppins mx-auto mt-8 block w-full rounded-2xl bg-[#1149a6] px-5 py-4 text-base font-extrabold text-white shadow-[0_14px_28px_-10px_rgba(17,73,166,0.8)] transition hover:-translate-y-0.5 hover:bg-[#0e3e8f] sm:max-w-[390px]">Reserve My FREE Seat <span aria-hidden="true">→</span></a>

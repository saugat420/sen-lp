  ...
  return (
    <main className="page-shell flex items-start justify-center">
      ...
      <section className="content-wrap max-w-2xl text-center">
        ...
        <p className="font-outfit mx-auto mt-6 max-w-md text-lg leading-8 text-black/70">Before the workshop, please watch this short video so you know what to do next.</p>
        ...
        <div className="mt-7 rounded-3xl border border-[#dbe5fa] bg-white/75 p-5 shadow-sm backdrop-blur sm:p-7">
          <p className="font-outfit mb-3 inline-flex items-center gap-2 rounded-full bg-[#fff1f2] px-3.5 py-2 text-base font-extrabold text-[#c61f29]"><span aria-hidden="true">⚠️</span> Must join group</p>
          <p className="font-outfit text-base leading-7 text-black/75">Join our official WhatsApp group to receive the workshop link, reminders, and important updates.</p>
          <a href={workshop.whatsappGroupLink} target="_blank" rel="noreferrer" className="font-outfit mx-auto mt-5 inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-6 py-3.5 text-base font-extrabold text-white shadow-[0_12px_22px_-12px_rgba(37,211,102,0.9)] transition hover:-translate-y-0.5 hover:bg-[#1ebc5a]">
